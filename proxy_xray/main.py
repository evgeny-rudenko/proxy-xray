...
def build_parser():
    ...
    parser.add_argument("--standby-pool-size", type=int, default=3)
    parser.add_argument("--pool-extra-reserve-per-slot", type=int, default=1)
    parser.add_argument("--pool-extra-max-per-host", type=int, default=1)
    parser.add_argument("--pool-extra-require-live", action=argparse.BooleanOptionalAction, default=True)
    ...
    parser.add_argument("--quality-check-interval", type=int, default=60)
    parser.add_argument("--quality-url", default="https://speed.cloudflare.com/__down?bytes=512000")
    parser.add_argument("--quality-min-kbps", type=float, default=1000)
    parser.add_argument("--quality-max-time", type=int, default=10)
    parser.add_argument("--quality-degrade-checks", type=int, default=2)
